<div>
    <x-theme.agri-page-header
        ...
        description="Update commodity price information"
    >
        <x-slot:actions>
            <x-theme.agri-button :href="route('market.show', $marketPrice)" variant="secondary">
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-zinc-200 dark:border-zinc-700">
                ...
                <x-theme.agri-button type="submit" variant="primary">
                    <span wire:loading.remove wire:target="save">Update Price</span>
