<div>
    <div class="mb-8">
        <a href="{{ route('farms.show', $farm) }}" wire:navigate class="inline-flex items-center gap-2 text-sm text-zinc-500 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-300 mb-4">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
            </svg>
            Back to {{ $farm->name }}
        </a>
        <h1 class="text-2xl font-light text-zinc-800 dark:text-white">Edit Farm</h1>
        <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">Update your farm details</p>
    </div>
    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 p-6">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    @if($farm->image_path && !$image)
                        <div class="mb-2 flex items-center gap-2">
                            <img src="{{ Storage::url($farm->image_path) }}" alt="Current image" class="w-16 h-16 object-cover rounded-lg">
                ...
                <div class="md:col-span-2">
                    <label class="flex items-center gap-3 cursor-pointer">
                        ...
                        >
                        <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300">Farm is active</span>
                    </label>
                </div>
            </div>
        </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-xs text-zinc-500 dark:text-zinc-400 mb-3">
                        Click "Use My Location" to update coordinates from your current position.
                    </p>
                </div>
        ...
        <div class="flex items-center justify-end gap-4">
            <a href="{{ route('farms.show', $farm) }}" wire:navigate class="px-6 py-2.5 text-sm font-medium text-zinc-600 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-200 transition-colors">
                Cancel
            </a>
            <button
                type="submit"
