    ...
    <form wire:submit="save" class="space-y-6 max-w-2xl">
        <x-theme.agri-card variant="white" class="border border-zinc-200 dark:border-zinc-700">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div>
                    <label for="expenseDate" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">
                ...
                <div>
                    <label for="vendor" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">
                        Vendor / Supplier
                    </label>
                    <input
                        type="text"
                ...
                <div class="md:col-span-2">
                    <label for="receipt" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">
                        Receipt / Invoice
                    </label>
                    <input
                        type="file"
