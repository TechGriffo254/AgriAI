{{--
    Inventory Category Icon Partial

    Usage:
    @include('livewire.inventory.partials.category-icon', ['category' => 'seeds', 'size' => 'md'])
--}}

@props(['category' => 'other', 'size' => 'md'])
...
@switch($category)
    @case('seeds')
        <svg class="{{ $iconSize }} text-agri-olive" fill="none" stroke="currentColor" viewBox="0 0 24 24">
